...
const homeSections = {
  ...
  welcomeTitle: 'Hi! I\'m Claire Fagin — a mother, doula, birth educator, and pediatric sleep and development mentor.',
  whyEyebrow: 'Why?',
  ...
  workWithMeEyebrow: 'WORK WITH ME',
  workWithMeTitle: '1:1 Sleep Guidance',
  workWithMeCtaTitle: 'Not sure where to start?',
  workWithMeCtaText: 'Sleep can feel big, I know. If you are looking for evidence-based information that respects biological rhythms, fosters secure attachment, and honors your child\'s nuanced needs, look no further.',
...
const servicePackages = [
  {
    ...
    detailContent: {
      fullDescription: [
        {
          ...
          children: [{
            _type: 'span',
            _key: 'span1',
            text: 'This single session is perfect for families who need expert guidance and a clear plan to move forward with confidence. We\'ll dive deep into your specific sleep challenges and create a personalized approach that honors your baby\'s unique needs.'
          }]
        }
      ],
      whatsIncluded: [
      ...
      bookingInfo: 'Sessions are available Monday-Friday. After booking, you\'ll receive a questionnaire to help me prepare for our call.'
    }
  },
  {
    _id: 'service_2',
      ...
      fullDescription: [
        {
          ...
          children: [{
            _type: 'span',
            _key: 'span1',
            text: 'This package provides consistent support as you implement changes and navigate your baby\'s evolving sleep needs. With three calls spread over 6 weeks, we\'ll work together to create sustainable sleep solutions.'
          }]
        }
      ],
      whatsIncluded: [
        'Three 50-minute video consultations over 6 weeks',
        'Email support between sessions for quick questions',
        'Personalized sleep plan with adjustments as needed',
        'Resource library access',
        'Progress tracking and troubleshooting'
      ],
      bookingInfo: 'Calls are scheduled at 2-week intervals to allow time for implementation and observation. Flexible scheduling available.'
    }
  },
  {
    _id: 'service_3',
      ...
      fullDescription: [
        {
          ...
          children: [{
            _type: 'span',
            _key: 'span1',
            text: 'Our most complete support package for families ready for a full sleep transformation. With ongoing text support between calls, you\'ll never feel alone in your journey toward better sleep.'
          }]
        }
      ],
      whatsIncluded: [
        'Three 50-minute video consultations',
        'Daily text support via Voxer or WhatsApp',
        'Comprehensive sleep plan with week-by-week guidance',
        'Full resource library and guides',
        'Priority scheduling and emergency support',
        '6 weeks of continuous guidance'
      ],
      bookingInfo: 'This intensive support begins immediately upon booking. Text support is available Monday-Friday, 9am-5pm PST, with 24-hour response time.'
    }
  }
];
...
console.log('📝 Creating structured Sanity import files...\n');
writeNDJSON('structured-content.ndjson', allData);

console.log('\n✨ Structured content files created!');
console.log('\nTo import this data into Sanity, run:');
console.log('npx sanity dataset import structured-content.ndjson production');
console.log('\nThis will add:');
console.log('- Homepage sections with all content');
console.log('- 5 Principles');
console.log('- 3 Service packages with details');
console.log('\nThen update your HTML to use the new data attributes!');